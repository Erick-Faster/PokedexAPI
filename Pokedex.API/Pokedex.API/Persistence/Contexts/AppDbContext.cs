...
namespace Pokedex.API.Persistence.Contexts
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Trainer>().HasKey(p => p.IdTrainer);
            builder.Entity<Trainer>().Property(p => p.IdTrainer).IsRequired();
            ...
            builder.Entity<Endereco>().HasKey(p => p.IdEndereco);
            ...
            builder.Entity<Pokemon>().HasKey(p => p.IdPokemon);
            ...
            builder.Entity<PokedexInfo>().HasKey(p => p.IdPokedex);
            builder.Entity<PokedexInfo>().Property(p => p.IdPokedex).IsRequired();
