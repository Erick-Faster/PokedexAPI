...
namespace Pokedex.API.Domain.Services
{
    public interface IPokedexInfoService
    {
        ...
        Task<SavePokedexInfoResponse> GetById(Guid id);
        Task<SavePokedexInfoResponse> SaveAsync(PokedexInfo pokedexInfo);
        Task<SavePokedexInfoResponse> UpdateAsync(Guid id, PokedexInfo pokedexInfo);
        Task<SavePokedexInfoResponse> DeleteAsync(Guid id);
    }
}
